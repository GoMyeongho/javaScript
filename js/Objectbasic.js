...
// 객체는 중괄호를 사용하여 만들며, 속성(property)과 값(value)으로 구성
// 객체는 객체 리터럴을 사용하여 생성
...
const person4 = new PersonClass("안유진",21,"서울시 강남구 역삼동");
const person5 = new PersonClass("장원영",20,"서울시 강남구 청담동");
const person6 = new PersonClass("이서  ",18,"서울시 강남구 삼성동");
